...
const markdownPrintStyle='@page{margin:16mm 14mm}body.markdown-body{box-sizing:border-box;max-width:860px;margin:40px auto;padding:0 32px;color:#1f2328}table{display:table;width:100%}pre{white-space:pre-wrap;word-break:break-word}pre,table,blockquote{break-inside:avoid;page-break-inside:avoid}h1,h2,h3{break-after:avoid;page-break-after:avoid}p,li{orphans:3;widows:3}@media print{body.markdown-body{max-width:none;margin:0;padding:0}pre{overflow:visible}}';
